...
![メインダッシュボード](images/main-dashboard.png)
...
![勤怠履歴画面](images/attendance-history.png)
...
**A:** Webブラウザから利用可能ですが、現バージョンではPCでの使用を推奨しています。将来のバージョンでモバイル対応を予定しています。
